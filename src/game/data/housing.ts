...
export const FURNITURE: FurnitureDefinition[] = [
  ...
  { id: "forge_portable", name: "Forge Portable", description: "Permet de forger dans le havre.", icon: "🔨", category: "functional", cost: 500, size: { w: 2, h: 2 }, bonus: { type: "craft", value: 1 } },
  { id: "trophe_boss", name: "Trophée de Boss", description: "Montre vos victoires.", icon: "🏆", category: "trophy", cost: 0, size: { w: 1, h: 1 } },
  { id: "plante_ether", name: "Plante d'Éther", description: "Purifie l'air du havre.", icon: "🪴", category: "decoration", cost: 30, size: { w: 1, h: 1 } },
  ...
  { id: "fontaine_stellaire", name: "Fontaine Stellaire", description: "Pièce maîtresse du havre.", icon: "⛲", category: "decoration", cost: 800, size: { w: 2, h: 2 } },
];
